...
import PageShape2 from "./svgs/page-shape-2";
        ...
        <main className="min-h-screen flex flex-col">
          ...
          <div className="flex flex-col grow">
            ...
            >
              ...
              <div className="w-full z-[14] grid mx-auto max-lg:min-h-[10.625rem] max-lg:max-w-[22.5rem] max-lg:grid-cols-[100%] max-lg:grid-rows-[minmax(64px,auto)_minmax(208px,auto)_1fr] max-lg:px-4 lg:min-h-[24.1875rem] lg:max-w-[76.5rem] lg:grid-cols-[25.2451%_49.5098%_25.2451%] lg:grid-rows-[minmax(80px,auto)_minmax(250px,auto)_1fr] lg:px-0">
                <div className="text-center w-full h-full relative z-[1] grid grid-cols-[100%] row-start-2 row-end-3 transition-[transform,translate,scale,rotate,opacity] duration-[0.65s] delay-[0.1s] max-lg:col-start-1 max-lg:col-end-2 lg:col-start-2 lg:col-end-3">
                  ...
                  >
                    <h1 className="font-heading text-ploy-text-primary font-bold break-words max-[921px]:mb-0 max-lg:leading-[3.25rem] max-lg:text-[2.5rem] lg:leading-[5.2rem] lg:text-[4rem]">
                      <span className="font-heading [color:inherit] break-words lg:text-[4rem]">
                        <strong className="[color:inherit] break-words">
                          {"články na tému varixy dolných končatín"}
                        </strong>
                      </span>
                    </h1>
                  </div>
            ...
            >
              ...
              <div
                id="zPsfqM"
                className="h-full z-[14] flex flex-col justify-between items-center col-start-1 col-end-[-1] row-start-1 row-end-[-1] py-10 block-blog-list max-lg:px-4 lg:px-[2.875rem]"
              >
                <div className="max-w-full grid block-blog-list__list max-[921px]:w-full max-[921px]:grid-cols-[repeat(1,_1fr)] max-lg:gap-2 lg:w-[76.5rem] lg:gap-8 lg:grid-cols-[repeat(4,1fr)]">
                  <div className="relative flex flex-col cursor-pointer transition-[transform,translate,scale,rotate,opacity] duration-[0.65s] delay-[0.1s] rounded-[0.3125rem] block-blog-list-item">
                    ...
                    >
                      ...
                      <p className="font-heading [color:inherit] leading-tight opacity-80 mb-3 block-blog-list-item__description">
                        {
                ...
                <div className="self-center flex items-center block-blog-list__pagination">
                  <button
                    aria-label="Previous page"
                    disabled={true}
                    className="text-black leading-[1.6em] text-xs min-w-9 min-h-9 block cursor-pointer transition-[color] duration-300 ease-[ease-in-out] px-px py-1 pagination__button hover:text-ploy-accent-primary-500"
                  >
                    <PageShape1 />
                  </button>
                  <button
                    ...
                    disabled={true}
                    className="text-ploy-accent-primary-500 leading-[1.6em] font-medium text-xs min-w-9 min-h-9 block cursor-pointer transition-[color] duration-300 ease-[ease-in-out] px-px py-1 pagination__button"
                  >
                    {"1"}
                  </button>
                  <button
