...
/**
 * @ployComponent
 * @ployComponentId ako-bolia-krcove-zily-priznaky-prejavy-a-mozne-komplikacie-hero-section
...
export default function HeroSection() {
  return (
    <div className="flex flex-col grow">
      ...
      >
        <div className="bg-ploy-background-primary absolute z-[13] transition-[background-color,height] duration-[0.3s,0.001s] ease-[ease-in-out,linear] delay-[0s,999s] inset-0 overflow-hidden text-ploy-text-primary" />
        <div className="w-full z-[14] grid mx-auto max-lg:min-h-[8.75rem] max-lg:max-w-[22.5rem] max-lg:grid-cols-[100%] max-lg:grid-rows-[minmax(40px,auto)_minmax(320px,auto)_minmax(64px,auto)_minmax(9223px,auto)_1fr] max-lg:px-4 lg:min-h-[341.5625rem] lg:max-w-[76.5rem] lg:grid-cols-[16.8301%_66.3399%_16.8301%] lg:grid-rows-[minmax(40px,auto)_minmax(344px,auto)_minmax(58px,auto)_minmax(4799px,auto)_1fr] lg:px-0">
