...
export const items: ListItemProps[] = [
  {
    className:
      "text-left w-full h-full relative z-[9] grid grid-cols-[100%] col-start-1 transition-[transform,translate,scale,rotate,opacity] duration-[0.65s] delay-[0.1s] max-lg:col-end-2 max-lg:row-start-13 max-lg:row-end-[14] lg:col-end-5 lg:row-start-[18] lg:row-end-[19] lg:mt-6",
    id: "zOT9JA",
    titleClassName:
      "font-heading text-ploy-text-on-accent-primary font-semibold break-words max-[921px]:mb-0 max-lg:leading-6 max-lg:text-xl lg:leading-tight lg:text-2xl",
  ...
  {
    className:
      "text-left w-full h-full relative z-[11] grid grid-cols-[100%] col-start-1 transition-[transform,translate,scale,rotate,opacity] duration-[0.65s] delay-[0.1s] max-lg:col-end-2 max-lg:row-start-[15] max-lg:row-end-[16] lg:col-end-7 lg:row-start-[19] lg:row-end-[20] lg:mt-6",
    id: "z0noKi",
    titleClassName:
      "font-heading text-ploy-text-on-accent-primary font-semibold break-words max-[921px]:mb-0 max-lg:leading-6 max-lg:text-xl lg:text-2xl",
  ...
  return (
    <div className="flex flex-col grow">
      ...
      >
        ...
        <div className="w-full z-[14] grid mx-auto max-lg:max-w-[22.5rem] max-lg:grid-cols-[100%] max-lg:grid-rows-[minmax(78px,auto)_minmax(54px,auto)_minmax(52px,auto)_minmax(4px,auto)_minmax(26px,auto)_minmax(26px,auto)_minmax(61px,auto)_minmax(47px,auto)_minmax(10px,auto)_minmax(54px,auto)_minmax(26px,auto)_minmax(4px,auto)_minmax(26px,auto)_minmax(12px,auto)_minmax(52px,auto)_minmax(56px,auto)_minmax(209px,auto)_minmax(55px,auto)_minmax(200px,auto)_minmax(56px,auto)_minmax(52px,auto)_minmax(28px,auto)_minmax(320px,auto)_minmax(16px,auto)_minmax(320px,auto)_minmax(16px,auto)_minmax(320px,auto)_minmax(16px,auto)_minmax(320px,auto)_1fr] max-lg:px-4 lg:max-w-[76.5rem] lg:grid-cols-[10.2941%_11.683%_1.55229%_1.79739%_0.245098%_1.38889%_1.55229%_0.408497%_1.22549%_2.53268%_0.980392%_15.8497%_0.980392%_7.43464%_0.980392%_24.2647%_6.53595%_10.2941%] lg:grid-rows-[minmax(98px,auto)_minmax(6px,auto)_minmax(56px,auto)_minmax(10px,auto)_minmax(54px,auto)_minmax(16px,auto)_minmax(21px,auto)_minmax(28px,auto)_minmax(31px,auto)_minmax(26px,auto)_minmax(62px,auto)_minmax(16px,auto)_minmax(62px,auto)_minmax(13px,auto)_minmax(54px,auto)_minmax(16px,auto)_minmax(21px,auto)_minmax(23px,auto)_minmax(62px,auto)_minmax(64px,auto)_minmax(456px,auto)_minmax(16px,auto)_minmax(456px,auto)_1fr] lg:px-0">
