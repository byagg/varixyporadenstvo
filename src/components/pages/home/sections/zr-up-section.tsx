export default function ZrUpSection() {
  return (
    ...
    >
      ...
      <div className="w-full z-[14] grid grid-cols-[100%] grid-rows-[1fr] mx-auto max-lg:min-h-5 max-lg:max-w-[22.5rem] max-lg:px-4 lg:min-h-6 lg:max-w-[76.5rem] lg:px-0" />
    </section>
  );
}
