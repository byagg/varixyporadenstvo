  ...
  return (
    ...
    >
      ...
      <div className="w-full z-[14] grid mx-auto max-lg:max-w-[22.5rem] max-lg:grid-cols-[12.5%_2.43902%_0.914634%_0.914634%_66.4634%_0.609756%_1.21951%_2.43902%_12.5%] max-lg:grid-rows-[minmax(40px,auto)_minmax(208px,auto)_minmax(16px,auto)_minmax(50px,auto)_minmax(30px,auto)_minmax(240px,auto)_minmax(30px,auto)_minmax(50px,auto)_minmax(30px,auto)_minmax(50px,auto)_1fr] max-lg:px-4 lg:max-w-[76.5rem] lg:grid-cols-[8.41503%_0.490196%_7.92484%_10.6209%_1.38889%_7.02614%_12.0098%_1.63399%_0.980392%_30.6373%_18.8725%] lg:grid-rows-[minmax(50px,auto)_minmax(14px,auto)_minmax(201px,auto)_minmax(55px,auto)_minmax(64px,auto)_minmax(16px,auto)_minmax(64px,auto)_minmax(80px,auto)_1fr] lg:px-0">
        ...
        <div className="text-start w-full h-full relative z-[3] grid grid-cols-[100%] max-lg:col-start-2 max-lg:col-end-9 max-lg:row-start-6 max-lg:row-end-7 lg:col-start-10 lg:col-end-11 lg:row-start-3 lg:row-end-9">
          <div
            id="z4ypyr"
            className="self-start w-full h-full col-start-1 col-end-[-1] row-start-1 row-end-[-1] image-wrapper image-wrapper--layout layout-element__component--GridImage max-[921px]:w-full max-[921px]:h-full max-lg:max-h-60 lg:max-h-[30.0313rem]"
          >
            <div
              rel="nofollow"
            ...
            >
              <img
                ...
                src="/migrated-assets/b45481cf7e17dee2d2c9.jpg"
                height="480"
                width="375"
                loading="eager"
            ...
            >
              <img
                alt="Vyšetrenie a poradenstvo pri kŕčových žilách"
                src="/migrated-assets/1e3b5e9eb2acadc96e56.jpg"
                height="240"
                width="246"
                loading="eager"
                className="w-full h-full max-w-none object-cover image__image overflow-clip"
