...
export default function PrevenciaVarixovSection() {
  return (
    ...
    >
      ...
      <div className="w-full z-[14] grid mx-auto max-lg:max-w-[22.5rem] max-lg:grid-cols-[3.96341%_90.8537%_5.18293%] max-lg:grid-rows-[minmax(16px,auto)_auto_minmax(370px,auto)_minmax(393px,auto)_1fr] max-lg:px-4 lg:max-w-[76.5rem] lg:grid-cols-[16.8301%_36.6013%_4.65686%_12.9902%_28.9216%] lg:grid-rows-[minmax(64px,auto)_minmax(96px,auto)_auto_minmax(23px,auto)_1fr] lg:px-0">
        <div
