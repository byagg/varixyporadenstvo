/**
 * @ployComponent
 * @ployComponentId nakup-hero-section
...
export const items: ListItemProps[] = [
  {
    className:
      "[color:inherit] bg-ploy-background-inverse w-full h-0.5 absolute block transition-[transform,translate,scale,rotate,opacity,width] duration-[0.25s] ease-[ease-in-out] delay-[0.1s] rounded-sm top-0",
  },
  {
    className:
      "[color:inherit] bg-ploy-background-inverse w-full h-0.5 absolute block transition-[transform,translate,scale,rotate,opacity,width] duration-[0.25s] ease-[ease-in-out] delay-[0.1s] rounded-sm top-2",
  },
  {
    className:
      "[color:inherit] bg-ploy-background-inverse w-full h-0.5 absolute block transition-[transform,translate,scale,rotate,opacity,width] duration-[0.25s] ease-[ease-in-out] delay-[0.1s] rounded-sm top-4",
  },
];
